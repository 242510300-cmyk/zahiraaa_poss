...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select name="kategori" class="form-select" required>
                    ...
                    <option value="Makanan" <?php echo e(old('kategori') == 'Makanan' ? 'selected' : ''); ?>>Makanan</option>
                    <option value="Minuman" <?php echo e(old('kategori') == 'Minuman' ? 'selected' : ''); ?>>Minuman</option>
                </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MILANN_POS\resources\views/jenis-makanan/create.blade.php ENDPATH**/ ?>