        ...
        <div class="receipt-card">
            ...
            <div class="payment-summary">
                <div class="payment-row">
                    ...
                    <strong>Rp <?php echo e(number_format($penjualan->uang_dibayar ?? $penjualan->total_pembayaran ?? 0, 0, ',', '.')); ?></strong>
                </div>
                <div class="payment-row change">
                    <span>Kembalian</span>
                    <strong>Rp <?php echo e(number_format($penjualan->kembalian ?? 0, 0, ',', '.')); ?></strong>
                </div>
            </div>
