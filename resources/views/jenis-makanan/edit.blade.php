...
<div class="container my-4">
    <div class="form-container">
        <h1 class="page-title mb-4">Edit Jenis Makanan</h1>

        <form action="{{ route('jenis-makanan.update', $jenisMakanan) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-3">
                <label class="form-label fw-semibold">Nama Jenis</label>
                <input type="text" name="nama" value="{{ old('nama', $jenisMakanan->nama) }}" class="form-control" required>
