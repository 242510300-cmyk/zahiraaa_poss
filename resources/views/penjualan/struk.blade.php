...
<head>
    <meta charset="UTF-8">
    <title>Struk #TRX-{{ $penjualan->id }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="receipt-card">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <strong>#TRX-{{ $penjualan->id }}</strong>
                </div>
                <div class="info-item">
                    <small>Tanggal</small>
                    <strong>{{ $penjualan->created_at ? $penjualan->created_at->format('d M Y, H:i') : '-' }}</strong>
                </div>
                <div class="info-item">
                    <small>Kasir</small>
                ...
                <div class="info-item">
                    ...
                    <span class="badge-status">{{ strtoupper($penjualan->metode_pembayaran ?? 'CASH') }}</span>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="item-sub">
                                {{ $item->kuantitas }} x Rp {{ number_format($item->harga_satuan ?? $item->harga ?? 0, 0, ',', '.') }}
                            </span>
                        </td>
